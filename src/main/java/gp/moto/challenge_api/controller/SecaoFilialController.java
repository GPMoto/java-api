...
@RestController
@RequestMapping("api/secao-filial")
public class SecaoFilialController {
    ...
    public ResponseEntity<List<SecaoFilial>> findAllByFilial(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SecaoFilial> update(
        @PathVariable Long id,
        @RequestBody SecaoFilialDto dto
    ) {
